        ...
        while (true)
        {
            ...
            switch (choice)
            {
                ...
                case 4:
                    {
                        ...
                        Console.WriteLine();
                        List<Shop> res = Shop.GetExpensive(way, price);
                ...
                case 5:
                    {
                        ...
                        Console.WriteLine();
                        List<Shop> res = Shop.LowStock(way, limit);
                        for (int i = 0; i < res.Count; i++)
                        {
                            Console.WriteLine(res[i]);
                            Console.WriteLine("---------------------");
                ...
                case 6:
                    {
                        Console.WriteLine();
                        Console.WriteLine("Средняя цена: " + Shop.AveragePrice(way));
                        break;
                    }
                case 7:
                    {
                        ...
                        Shop max = Shop.ExpensiveProduct(way);
